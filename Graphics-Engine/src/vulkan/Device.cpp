...
namespace Vk
{
	...
	VkCommandBuffer Device::beginCommandBuffer(const VkCommandPool commandPool) const
	{
	...
	void Device::endCommandBuffer(VkCommandBuffer commandBuffer, const VkCommandPool commandPool) const
	{
